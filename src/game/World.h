...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_CUSTOM_RESET_TALENTS_CAP,
    CONFIG_UINT32_INSTANT_TAXI_LEVEL,
    CONFIG_UINT32_INSTANT_TAXI_ITEM1,
    CONFIG_UINT32_INSTANT_TAXI_ITEM2,
    CONFIG_UINT32_INSTANT_TAXI_ITEM3,
